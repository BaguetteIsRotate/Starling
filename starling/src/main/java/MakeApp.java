...
public class MakeApp extends JFrame{
    ...
    public JPanel PageMain(){
        ...
        button1.addComponentListener(new ComponentAdapter() {
            public void componentResized(ComponentEvent e){
                ImageIcon icon = resizeImageIcon("starling/src/main/images/happy_icon.png",(button1.getHeight()/4),button1.getWidth()/4);
        ...
        pondering.addComponentListener(new ComponentAdapter() {
            public void componentResized(ComponentEvent e){
                ImageIcon title1 = resizeImageIcon("starling/src/main/images/app_title.png",(MakeApp.this.getHeight()/2),MakeApp.this.getWidth());
                pondering.setIcon(title1);
            }
        });
        button2.addComponentListener(new ComponentAdapter() {
            public void componentResized(ComponentEvent e){
                ImageIcon icon = resizeImageIcon("starling/src/main/images/info_icon.png",(button2.getHeight()/4),button2.getWidth()/4);
                button2.setIcon(icon);
            }
        });
    ...
    public JPanel PageTwo(){
        ...
        buttonMain.addComponentListener(new ComponentAdapter() {
            public void componentResized(ComponentEvent e){
                ImageIcon icon = resizeImageIcon("starling/src/main/images/main_icon.png",(buttonMain.getHeight()/2),buttonMain.getWidth()/2);
                buttonMain.setIcon(icon);
            }
        });
        ...
        JButton button2 = new JButton();
        page.add(button2,BorderLayout.EAST);
        button2.setSize(200,100);
        ImageIcon icon2 = resizeImageIcon("starling/src/main/images/info_icon.png",50,50);
        button2.setIcon(icon2);
        button2.addComponentListener(new ComponentAdapter() {
            public void componentResized(ComponentEvent e){
                ImageIcon icon = resizeImageIcon("starling/src/main/images/info_icon.png",(button2.getHeight()/2),button2.getWidth()/2);
                button2.setIcon(icon);
            }
        });
        button2.addActionListener(e->{
    ...
    public JPanel PageInfoA(String path,String title){
        ...
        try{
            ...
            String x = reader.readAllAsString();
            String[] a = x.split("\\n");
    ...
    public ImageIcon resizeImageIcon(String path, int height, int width) {
        ...
        if (ogheight <= 0 || icon.getIconWidth() <= 0) return icon;
